...
const MainLayout: React.FC = () => {
  ...
  return (
    <section className={styles.layout} data-aos='fade-in'>
          ...
          <Col lg={7}>
            <div className={styles.layout__content}>
              ...
              <div className={styles.content__body}>
                <h1 className={styles.content__body_title}>Happening now</h1>
                <h3 className={styles.content__body_description}>
                  Join Us today.
                </h3>
                <AuthLink to="/signup">Sign Up</AuthLink>
                <AuthLink to="/mainpage/artists">Enter as a Guest</AuthLink>
                <div className={styles.content__body_terms}>
